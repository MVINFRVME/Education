...
# Для начала было сгенерировано два набора чисел: nums_1 и nums_2
...
print(f"1-e множество: {nums_1}")
print(f"2-e множество: {nums_2}")

print(f"Минимальный элемент 1-го множества: {min(nums_1)}")
print(f"Минимальный элемент 2-го множества: {min(nums_2)}")

nums_1.remove(min(nums_1))
nums_2.remove(min(nums_2))

random_dig_1 = random.randint(100, 200)
random_dig_2 = random.randint(100, 200)

print(f"Случайное число для 1-го множества: {random_dig_1}")
print(f"Случайное число для 2-го множества: {random_dig_2}")

nums_1.add(random_dig_1)
nums_2.add(random_dig_2)

print(f"Объединение множеств: {nums_1 | nums_2}")
print(f"Пересечение множеств: {nums_1 & nums_2}")
print(f"Элементы, входящие в nums_2, но не входящие в nums_1: {nums_2 - nums_1}")
